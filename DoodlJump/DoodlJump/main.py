...
#handle movement of platforms as game progressing
...
while running == True:
    ...
    high_score_text = font.render('Air Jumps(Met ta tête en haut !): ' + str(super_jumps), True, black, background)
    screen.blit(high_score_text, (10, 10))

    if game_over:
        game_over_text = font.render('Game Over: Baisse la tête pour recommencer!', True, black, background)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_z and not game_over and super_jumps > 0:
                super_jumps -= 1
                y_change = -15
